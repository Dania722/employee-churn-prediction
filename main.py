...
# Aur poora import section yun karo:
...
my_feature_dict = joblib.load('my_feature_dict.pkl')
...
st.title('🧑‍💼 Employee Retention & Leave Prediction App')
st.subheader('Predict if an employee is likely to leave the company')
st.subheader('Made by Dania Ahmed')
